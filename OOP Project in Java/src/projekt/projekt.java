...
import java.io.*;
import java.util.*;
//Szymon Krzyzanowski : Klasa Main, Klasa Sedzia,Klasa Sedzia Pomocniczy,Instrukcja,
//Jakub Kalinowski : Klasa gra(bez  metod wczytywania), Klasa Komparator,Klasa KOmparator.pkt,opis bibliotek,
//Piotr Juchimowicz : Klasa Mecz,Klasa Siatkowka,Klasa DwaOgnie,Klasa PrzeciaganieLiny,Klasa Druzyna,Klasa Zawodnik,
//			Klasa Rozgrywki,  3 Metody wczytywania z klasy Gra,
            ...
            switch(wybor1)
            {
                ...
                + "Twoj wybor:");
                     ...
                     switch(wybor2)
                     {
                        ...
                        + "Podaj dane w kolejnoúci: imie, nazwisko, iloúś sedziowanych meczy.");
                              imie = input.next();
                              nazwisko = input.next();
                ...
                System.out.println(gra.szukajSedziego(imie,nazwisko));
                         ...
                         case 4:
                             ...
                             break;
                         case 5:
                             gra.Wczytywanie_Sedziow_z_pliku(input);//Metoda musi pobierac scannera,aby przy zamykaniu go w niej  nie zamknac strumienia wejscia
                             break;
                         case 6:
                 ...
                 System.out.println("DODAWANIE S DZIEGO POMOCNICZEGO\n"
                        + "Podaj dane w kolejnosci: imie, nazwisko, ilosc sddziowanych meczy.");
                 imie = input.next();
                nazwisko = input.next();
                 if(gra.czy_jest_sedzia_o_ImieniuiNaziwsku(imie, nazwisko))
                {
