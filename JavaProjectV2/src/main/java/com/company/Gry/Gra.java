...
public class Gra {
    ...
    public Sedzia szukajSedziego(String imie, String nazwisko) {              //szuka i zwraca sedziego
    ...
    {
        LinkedList<Druzyna> lista_druzyn = new LinkedList<Druzyna>();//Tworze liste druzyn na ktorej bede je przechowywal
        String nazwa_pliku;
        // Tworze obiekty typu Scanner do wczytywania z pliku i z klawiatury
        ...
        while (true) //Wczytuje do napotkania napisu koniec
        {
            ...
            //System.out.println(lista_pomocnicza.get(0).imie);
    ...
    public void Wczytywanie_Sedziow_z_pliku(Scanner inputt) throws FileNotFoundException//Doda konkretnego sedziego do bazy danych tylko gdy nie ma go tam jeszcze
    {
    ...
    public void Wczytywanie_Rozgrywek_z_Pliku(Scanner input) throws FileNotFoundException {
        ...
        while (pom < ile_rozgrywek) {
            ...
            if (czy_jest_sedzia_o_ImieniuiNaziwsku(imie, nazwisko) == false) {
    ...
    public void GeneratorPolfinalow(ArrayList<Druzyna> Druzyny, Rozgrywki TablicaPolfinalow[]) {
//    int i=0;
//    SedziaPomocniczy p1 = null;
//    SedziaPomocniczy p2 = null;
//    for(Sedzia s: Sedziowie){
//        if(s instanceof SedziaPomocniczy)
//            p1=new SedziaPomocniczy(s);
//    }
//    for(Sedzia s: Sedziowie){
//        if(i==0){
//            if(s instanceof SedziaPomocniczy){
...
//            }
//        }
//        else if(s instanceof SedziaPomocniczy){
//            p2=new SedziaPomocniczy(s);
//        }
//    }
//    Siatkowka ms= new Siatkowka();
//    DwaOgnie dwo= new DwaOgnie();
//    PrzeciaganieLiny pl= new PrzeciaganieLiny();
//    
//    Siatkowka ms1= new Siatkowka();
//    DwaOgnie dwo1= new DwaOgnie();
//    PrzeciaganieLiny pl1= new PrzeciaganieLiny();
//    Druzyna d[] = new Druzyna[4];
//    for(int j=0;j<4;j++)
//    {
//        d[j]=getDruzyny().get(j);
//    }
//    Rozgrywki tmp=new Rozgrywki(ms,dwo,pl,d[0], d[2]);
//    TablicaPolfinalow[0]=tmp;
//    Rozgrywki tmp1= new Rozgrywki(ms1,dwo1,pl1,d[1], d[3]);
//    TablicaPolfinalow[1]=tmp1;
    }

    public Rozgrywki[] getPolfinaly() {
        return polfinaly;
    }

    public void wyswietlPolfinaly() {
        System.out.println(polfinaly[0].getDruzynaA().getNazwa() + " - " + polfinaly[0].getDruzynaB().getNazwa());
        System.out.println(polfinaly[1].getDruzynaA().getNazwa() + " - " + polfinaly[1].getDruzynaB().getNazwa() + "\n");
    ...
    public void finall() {
        ...
        Siatkowka ms = new Siatkowka();
        ms.setSiatkowka(Sedziowie.get(0), p1, p2);
        DwaOgnie dwo = new DwaOgnie(Sedziowie.get(1));
        PrzeciaganieLiny pl = new PrzeciaganieLiny(Sedziowie.get(2));
        finall.setRozgrywki(ms, dwo, pl, polfinaly[0].zwyciezca(Druzyny), polfinaly[1].zwyciezca(Druzyny));
    }

    public void wyswietlFinal() {
        System.out.println(finall.getDruzynaA().getNazwa() + " - " + finall.getDruzynaB().getNazwa() + "\n");
    }
